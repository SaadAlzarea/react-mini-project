    ...
    <div className="min-h-screen">
      <div className="flex flex-col lg:flex-row justify-center items-center h-full gap-10 min-h-screen p-10">
        ...
        <div className="w-100 flex flex-col items-left gap-10">
          <p className="text-6xl font-bold text-center lg:text-left">
            JOIN US!
          </p>
          ...
          <div className="w-80 flex justify-center items-center gap-5">
            <button type="button" className="text-lg font-medium h-12 w-25 border rounded-lg text-black hover:border-2 hover:bg-gray-500"
            onClick={toRegister}>
              Register
            </button>
            <button type="button" className="text-lg font-medium h-12 w-25 border rounded-lg  text-black hover:border-2 hover:bg-gray-500"
